...
pgset 1 b000100  56  pg_cal, set WBC = pg_cal - 7
pgset 2 b000010  96  pg_trg  
...
--- set divgV2.1 chip ETH 206  = 426 DACs (no readout)
...
dac 253    4  CtrlReg
dac 254   59  WBC (159 to get 79 pixel/DC, but not 80 = erase)
dac 255   12  RBreg
