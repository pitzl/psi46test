...
-- start L1 module: proc600v2, TBM10c
--------------------------------------------------------------------------------
...
module 1047 # must be 1000..1099 for L1 modules with 2 TBMs

modsel2 31  # set HubID (and i-1)
#modsel2 29  # set HubID (and i-1)
#modsel2 27  # set HubID (and i-1)

select 0:15  # all ROCs active

seltbm 0 # ROCs 4-7 and 8-11
tbm10

seltbm 1 # ROCs 0-4 and 12-15
tbm10
